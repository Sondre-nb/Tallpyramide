...
// 32767 ganger kjørt
function finnVerdi(plass, rad, verdi){
    if (rad < pyramide.length - 1) {
        finnVerdi(plass, rad+1, verdi + pyramide[rad][plass])
        finnVerdi(plass+1, rad+1, verdi + pyramide[rad][plass])
    } else {
...
// 473 ganger kjørt
function finnVerdi2(plass, rad, verdi){
    if (rad < pyramide.length - 1) {
        if (sumpyramide[rad+1][plass] != 0 && sumpyramide[rad+1][plass+1] != 0) {
            if (sumpyramide[rad+1][plass] > sumpyramide[rad+1][plass+1]) {
                ...
                sjekkVerdi(verdi + sumpyramide[rad+1][plass] + pyramide[rad][plass])
            } else {
                sumpyramide[rad][plass] = pyramide[rad][plass] + sumpyramide[rad+1][plass+1]
                sjekkVerdi(verdi + sumpyramide[rad+1][plass+1] + pyramide[rad][plass])
            }
        } else {
            finnVerdi2(plass, rad+1, verdi + pyramide[rad][plass])
            finnVerdi2(plass+1, rad+1, verdi + pyramide[rad][plass])
        }
    } else {
        sjekkVerdi(verdi + pyramide[rad][plass])
    }
}
